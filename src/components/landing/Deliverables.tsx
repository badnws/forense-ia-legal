...
const items = [
  {
    ...
    desc: "Verificação técnica de origem, metadados, consistência física e indícios de adulteração.",
  },
  {
    icon: Fingerprint,
    title: "Detecção de IA e deepfake",
    desc: "Identificação de imagens sintéticas, montagens e troca de rostos com ferramentas forenses atualizadas.",
  },
  {
    icon: FileBadge2,
    title: "Laudo pericial completo",
    desc: "Documento técnico fundamentado, com metodologia descrita e validade para uso processual.",
  },
  {
    icon: Gavel,
    title: "Assistência técnica",
    desc: "Pareceres, quesitos e atuação como assistente técnico em processos judiciais e administrativos.",
  },
];
