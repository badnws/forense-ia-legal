const steps = [
  {
    n: "01",
    title: "Você envia o caso",
    desc: "Pelo WhatsApp ou pelo formulário, com a imagem e contexto da demanda.",
  },
  {
    n: "02",
    title: "Avaliação e orçamento",
    desc: "Análise preliminar de viabilidade, definição de escopo, prazo e honorários.",
  },
  {
    n: "03",
    title: "Laudo entregue",
    desc: "Emissão do laudo técnico no prazo combinado, pronto para uso processual.",
  },
];
